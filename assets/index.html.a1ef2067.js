import{_ as e,o as n,c as t,d as o}from"./app.7052c443.js";const r={},i=o(`<h1 id="ecmascript-\u653B\u7565" tabindex="-1"><a class="header-anchor" href="#ecmascript-\u653B\u7565" aria-hidden="true">#</a> ECMAScript \u653B\u7565</h1><h2 id="array-flat-flatmap" tabindex="-1"><a class="header-anchor" href="#array-flat-flatmap" aria-hidden="true">#</a> Array#{flat,flatMap}</h2><p>ECMAScript 2019 \u5728 <code>Array.prototype</code> \u4E0A\u589E\u52A0\u4E86\u4E24\u4E2A\u65B9\u6CD5:<code>flat()</code>\u548C <code>flatMap()</code>\u3002</p><p>\u8FD9\u4E24\u4E2A\u65B9\u6CD5\u4E3A\u6253\u5E73\u6570\u7EC4\u63D0\u4F9B\u4E86\u4FBF\u5229\u3002\u5982\u679C\u6CA1\u6709\u8FD9\u4E24\u4E2A\u65B9\u6CD5\uFF0C\u5219\u6253\u5E73\u6570\u7EC4\u5C31\u8981\u4F7F\u7528\u8FED\u4EE3\u6216\u9012\u5F52</p><pre><code>// \u624B\u5199\u5B9E\u73B0
/*
...
// [0, 1, 2, 3, [4, 5], 6]
</code></pre><p>\u6570\u7EC4\u7684\u6210\u5458\u6709\u65F6\u8FD8\u662F\u6570\u7EC4\uFF0C<code>Array.prototype.flat()</code>\u7528\u4E8E\u5C06\u5D4C\u5957\u7684\u6570\u7EC4 \u201C\u62C9\u5E73\u201D\uFF0C\u53D8\u6210\u4E00\u7EF4\u7684\u6570\u7EC4\u3002\u8BE5\u65B9\u6CD5\u8FD4\u56DE\u4E00\u4E2A\u65B0\u6570\u7EC4\uFF0C\u5BF9\u539F\u6570\u636E\u6CA1\u6709\u5F71\u54CD\u3002</p><pre><code>const arr1 = [0, 1, 2, [3, 4]];
...
// [[2], [4], [6], [8]]
</code></pre><p>\u5178\u578B\u573A\u666F: \u5C06\u5305\u542B\u51E0\u53E5\u8BDD\u7684\u6570\u7EC4\u62C6\u5206\u6210\u5355\u4E2A\u8BCD\u7EC4\u6210\u7684\u65B0\u6570\u7EC4</p><pre><code>let arr1 = [&quot;it&#39;s Sunny in&quot;, &quot;&quot;, &quot;California&quot;];
...
// { foo: true, bar: false }
</code></pre><h3 id="array-\u8F6C\u5316\u4E3A-object" tabindex="-1"><a class="header-anchor" href="#array-\u8F6C\u5316\u4E3A-object" aria-hidden="true">#</a> Array \u8F6C\u5316\u4E3A Object</h3><pre><code>const arr = [
  [&quot;0&quot;, &quot;a&quot;],
  [&quot;1&quot;, &quot;b&quot;],
  [&quot;2&quot;, &quot;c&quot;],
];
...
</code></pre><h3 id="\u6D4F\u89C8\u5668\u67E5\u8BE2\u53C2\u6570\u8F6C\u6362\u4E3A\u5BF9\u8C61" tabindex="-1"><a class="header-anchor" href="#\u6D4F\u89C8\u5668\u67E5\u8BE2\u53C2\u6570\u8F6C\u6362\u4E3A\u5BF9\u8C61" aria-hidden="true">#</a> \u6D4F\u89C8\u5668\u67E5\u8BE2\u53C2\u6570\u8F6C\u6362\u4E3A\u5BF9\u8C61</h3><pre><code>let query = Object.fromEntries(new URLSearchParams(&quot;foo=bar&amp;baz=qux&quot;));
// {foo: &quot;bar&quot;, baz: &quot;qux&quot;}
console.log(query);
</code></pre><h3 id="\u5C06\u5BF9\u8C61\u7684\u503C\u91CD\u65B0\u7EC4\u5408" tabindex="-1"><a class="header-anchor" href="#\u5C06\u5BF9\u8C61\u7684\u503C\u91CD\u65B0\u7EC4\u5408" aria-hidden="true">#</a> \u5C06\u5BF9\u8C61\u7684\u503C\u91CD\u65B0\u7EC4\u5408</h3><pre><code>let arr = [
  { name: &quot;Alice&quot;, age: 40 },
  { name: &quot;Bob&quot;, age: 36 },
];
...
// {Alice: 40, Bob: 36}
console.log(obj);
</code></pre><h2 id="string-trimstart-trimend" tabindex="-1"><a class="header-anchor" href="#string-trimstart-trimend" aria-hidden="true">#</a> String#{trimStart,trimEnd}</h2><p>ES2019 \u5BF9\u5B57\u7B26\u4E32\u5B9E\u4F8B\u65B0\u589E\u4E86<code>trimStart()</code>\u548C<code>trimEnd()</code>\u8FD9\u4E24\u4E2A\u65B9\u6CD5\u3002\u5B83\u4EEC\u7684\u884C\u4E3A\u4E0E<code>trim()</code>\u4E00\u81F4\uFF0C</p><ul><li><code>trimStart()</code>\u6D88\u9664\u5B57\u7B26\u4E32\u5934\u90E8\u7684\u7A7A\u683C\uFF0C</li><li><code>trimEnd()</code>\u6D88\u9664\u5C3E\u90E8\u7684\u7A7A\u683C\u3002</li></ul><p>\u5B83\u4EEC\u8FD4\u56DE\u7684\u90FD\u662F\u65B0\u5B57\u7B26\u4E32\uFF0C\u4E0D\u4F1A\u4FEE\u6539\u539F\u59CB\u5B57\u7B26\u4E32\u3002</p><pre><code>const s = &quot;  abc  &quot;;

s.trim(); // &quot;abc&quot;
s.trimStart(); // &quot;abc  &quot;
s.trimEnd(); // &quot;  abc&quot;
\u590D\u5236\u4EE3\u7801
</code></pre><h2 id="symbol-description" tabindex="-1"><a class="header-anchor" href="#symbol-description" aria-hidden="true">#</a> Symbol#description</h2><p>\u521B\u5EFA <code>Symbol</code> \u7684\u65F6\u5019\uFF0C\u53EF\u4EE5\u6DFB\u52A0\u4E00\u4E2A\u63CF\u8FF0\u3002</p><pre><code>const sym = Symbol(&quot;foo&quot;);
</code></pre><p>\u4E0A\u9762\u4EE3\u7801\u4E2D\uFF0C<code>sym</code> \u7684\u63CF\u8FF0\u5C31\u662F\u5B57\u7B26\u4E32 <code>foo</code>\u3002</p><p>\u4F46\u662F\uFF0C\u8BFB\u53D6\u8FD9\u4E2A\u63CF\u8FF0\u9700\u8981\u5C06 <code>Symbol</code> \u663E\u5F0F\u8F6C\u4E3A\u5B57\u7B26\u4E32\uFF0C\u5373\u4E0B\u9762\u7684\u5199\u6CD5\u3002</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>const sym = Symbol(&quot;foo&quot;);
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,63),a=[i];function d(s,c){return n(),t("div",null,a)}var u=e(r,[["render",d],["__file","index.html.vue"]]);export{u as default};
